 ...
 * @author Aniq Asyraaf
 */
@WebServlet(name = "CategoryEducation", urlPatterns = {"/CategoryEducation"})
public class CategoryEducation extends HttpServlet {    
    public CategoryEducation(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
