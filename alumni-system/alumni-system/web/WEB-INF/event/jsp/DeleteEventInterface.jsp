    ...
    <body>
        ...
        <div class="container-custom">
            ...
            <div class="jumbotron" style="padding-top:25px;padding-bottom: 10px;">
                ...
                <form  name="EventFilter" action="${pageContext.request.contextPath}/ManageEventControl" method="post">
                    <div class="col">
                        <div class="form-floating">
                          <label for="floatingInput">Event Category</label>                                                                                              
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="eventCateOpt" value="Sport" id="flexRadioDefault1">
                              <label class="form-check-label" for="flexRadioDefault1">
                                  Sport
                              </label>
                          </div>
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="eventCateOpt" value="Education" id="flexRadioDefault2">
                    ...
                    <label>       
                        <input class="btn btn-primary btn-sm" type="submit" name="Filter" id="Filter" value="Filter">
                    </label>
                </form>
                    ...
                    %>
                            <tr>
                                ...
                                <% int eventID =((Event)eventlist.get(i)).getEventID(); 
                                   String eventCategory = ((Event)eventlist.get(i)).getEventCategory();%>
                                <td> 
