                            ...
                            <div class="row g-2 p-2">
                                <div class="col">
                                  <div class="form-floating">
                                    ...
                                    <input type="text" class="form-control-plaintext" id="floatingInput" placeholder="Name of the Participant" name="userName" value="<%=user.getName()%>" size="100" readonly required>                                    
                                  </div>
                                </div>
                                <div class="col-md">
                                  <div class="form-floating">
                                    <label for="floatingInput">User ID</label>
                                    <input type="text" class="form-control-plaintext" id="floatingInput" placeholder="ID of the Participant" name="userID" value="<%=user.getUserID()%>" size="100" readonly required>                                    
                                  </div>
                                </div>
                            </div>
                            <div class="row g-2 p-2">
